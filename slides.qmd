...
<img src="images/gitignore.png" width="900px"/>
...
<img src="images/pull.png" width="800px"/>
...
## 
... But what if some issues remain unresolved?  👆*"You forgot to add code to read in the data!"* 🤔

. . .

<br/>

If the branch has not been removed, you may add smaller changes (on the same feature) through
...
❗ BUT if some time has passed and/or the addition is major ⏩ Checkout to  master branch:
...
... And then, the usual workflow (don't forget to push to the new branch!)
...
<img src="images/review_pull.png" width="150px"/>
